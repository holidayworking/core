...
ssh "$TARGET_HOST" "mkdir -p ~/.config/sops/age"
scp ~/.config/sops/age/keys.txt "$TARGET_HOST":~/.config/sops/age/keys.txt
ssh "$TARGET_HOST" "chmod 600 ~/.config/sops/age/keys.txt"
